...
// ==========================================
// 1. DATA: ROADMAP DATA (3 TRACKS)
// ==========================================
writeFile('src/data/roadmapData.js', `export const ROADMAP_TRACKS = {
  maang: {
    id: 'maang',
...
// ==========================================
// 2. DATA: STREAM / THEATER DATA
// ==========================================
writeFile('src/data/streamData.js', `export const LIVE_STREAMS = [
  {
    id: 'stream-1',
    title: 'Google L5 Mock Interview: Distributed Cache & Consistent Hashing',
  ...
  {
    id: 'stream-2',
    title: 'Meta E5 Live Coding: Hard Graph Traversal & Dynamic Programming',
  ...
  {
    id: 'stream-3',
    title: 'Smart Contract Exploit Teardown: $20M Flash Loan Oracle Hack',
  ...
  {
    id: 'stream-4',
    title: 'Amazon Principal Bar Raiser: Behavioral Masterclass & Case Studies',
    ...
    badge: 'RECORDED',
    duration: '48m',
    instructor: 'Amazon Bar Raiser',
    timestamp: '3 days ago'
  }
];
`);

console.log('Roadmap and Stream data created.');
